...
type Classification struct {
	...
	AudioCodec         *string                    `protobuf:"bytes,14,opt,name=audioCodec,proto3,oneof" json:"audioCodec,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *Classification) GetAudioCodec() string {
...
const file_internal_protobuf_bitmagnet_proto_rawDesc = "" +
	...
	"\rcontentSource\x18\r \x01(\tH\aR\rcontentSource\x88\x01\x01\x12#\n" +
	"\n" +
	"audioCodec\x18\x0e \x01(\tH\bR\n" +
	"audioCodec\x88\x01\x01\"\x83\x01\n" +
	"\vContentType\x12\v\n" +
	...
	"_contentIdB\x10\n" +
	"\x0e_contentSourceB\r\n" +
	"\v_audioCodecB\x14Z\x12/internal/protobufb\x06proto3"
